...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name': 'J.K. Rowling',
            'biography': 'J.K. Rowling is a British author best known for her Harry Potter series.'
        }
        self.app.post('/create_author', data=post_data)


        # TODO: Verify that the author was updated in the database
        created_author = Author.query.filter_by(name='J.K. Rowling').first()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.biography, 'J.K. Rowling is a British author best known for her Harry Potter series.')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Fantasy').first()
    ...
    def test_profile_page(self):
        ...
        response_text = response.get_data(as_text=True)
        self.assertIn("<p>You are logged in as me1</p>", response_text)
        # self.assertIn("I like to read books.", response_text)
